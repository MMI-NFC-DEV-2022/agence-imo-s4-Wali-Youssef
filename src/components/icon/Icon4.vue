    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
        ...
        <g clip-path="url(#clip0_29323_902)">
            ...
            <path
                ...
                stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M3.33337 17.5L4.16671 16.25" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round"
                stroke-linejoin="round"></path>
            <path d="M16.6667 17.5L15.8334 16.25" stroke="#6366F1" stroke-width="1.66667" stroke-linecap="round"
                stroke-linejoin="round"></path>
        </g>
        <defs>
